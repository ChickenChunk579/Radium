...
namespace Radium::Nodes
{
    ...
    void TileMap2D::Register()
    {
        ...
        LUA_FUNC("Radium::Nodes::TileMap2D::SetTile", [](lua_State* L) -> int {

        });

        LUA_FUNC("Radium::Nodes::TileMap2D::AddChunk", [](lua_State* L) -> int {

        });

        LUA_FUNC("Radium::Nodes::TileMap2D::GetChunk", [](lua_State* L) -> int {
    ...
    void TileMap2D::OnRender()
    {
        ...
        for (auto pair : chunks) {
            ...
            float drawX = (TileChunk::width * tileSize.x) * pos.x * scale;
            float drawY = (TileChunk::height * tileSize.y) * pos.y * scale;
