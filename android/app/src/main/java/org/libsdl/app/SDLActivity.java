...
*/
    ...
    void copyAssetToStorage(Context context, String assetPath, String destPath) {
        ...
        try (InputStream in = assetManager.open(assetPath);
            ...
            Log.e("CopyAsset", "Failed to copy asset file: " + assetPath, e);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new File(context.getFilesDir(), "assets").mkdirs();  // not "myfolder"


        copyAssetToStorage(context, fileName, outPath);


        AlertDialog.Builder dlgAlert1  = new AlertDialog.Builder(this);
        dlgAlert1.setMessage("Copied assets!");
        dlgAlert1.setTitle("Status");
